...
public class Level5Frame extends JFrame implements ActionListener
{
    //Data Members
    //String
    ...
    //Labels
    private JLabel title = new JLabel("LEVEL 5");
    ...
    private JButton startButton = new JButton("Start Level 5");
    ...
    public void actionPerformed(ActionEvent e)
    {
       ...
       if(e.getSource() == startButton)
       {
          ...
          timer.scheduleAtFixedRate(changeNumber, 1500, 500);
       ...
       if(e.getSource() == confirmNumberButton)
       {
           //Clear screen
            ...
            actualOrderLabel.setBounds(110, 18, 290, 20);
