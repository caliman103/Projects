...
public class Level1Frame extends JFrame implements ActionListener
{
    //Data Members
    //String
    ...
    //Labels
    private JLabel title = new JLabel("LEVEL 1");
    ...
    private JButton startButton = new JButton("Start Level 1");
    ...
    public void actionPerformed(ActionEvent e)
    {
       ...
       if(e.getSource() == startButton)
       {
          ...
          popUpNumbersLabel.setForeground(Color.CYAN);
          ...
          timer.scheduleAtFixedRate(changeNumber, 2500, 1500);
       ...
       if(e.getSource() == confirmNumberButton)
       {
           //Clear screen
            ...
            actualOrderLabel.setForeground(Color.CYAN);
            actualOrderLabel.setVerticalAlignment(JLabel.CENTER);

            actualOrderLabel.setBounds(170, 18, 200, 20);
