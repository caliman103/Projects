...
public class Level3Frame extends JFrame implements ActionListener
{
    //Data Members
    //String
    ...
    //Labels
    private JLabel title = new JLabel("LEVEL 3");
    ...
    private JButton startButton = new JButton("Start Level 3");
    ...
    public void actionPerformed(ActionEvent e)
    {
       ...
       if(e.getSource() == startButton)
       {
          ...
          timer.scheduleAtFixedRate(changeNumber, 2000, 1000);
       ...
       if(e.getSource() == confirmNumberButton)
       {
           //Clear screen
            ...
            actualOrderLabel.setBounds(145, 18, 200, 20);
