...
public class Level2Frame extends JFrame implements ActionListener
{
    //Data Members
    //String
    ...
    //Labels
    private JLabel title = new JLabel("LEVEL 2");
    ...
    private JButton startButton = new JButton("Start Level 2");
    ...
    public void actionPerformed(ActionEvent e)
    {
       ...
       if(e.getSource() == startButton)
       {
          ...
          popUpNumbersLabel.setForeground(Color.BLUE);
          ...
          timer.scheduleAtFixedRate(changeNumber, 2300, 1300);
       ...
       if(e.getSource() == confirmNumberButton)
       {
           //Clear screen
            ...
            actualOrderLabel.setForeground(Color.BLUE);
            actualOrderLabel.setVerticalAlignment(JLabel.CENTER);

            actualOrderLabel.setBounds(155, 18, 200, 20);
